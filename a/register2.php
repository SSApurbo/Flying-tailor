...
$sql = "SELECT * FROM tailor WHERE email = $email";
$stmt = $conn->prepare($sql);
$stmt->execute();

if($stmt->rowCount() == 0){
	$query = "INSERT INTO tailor (username,email,password) VALUES('$uname','$email','$pass')";
	...
	echo "<script>location.assign('index2.php');</script>";
